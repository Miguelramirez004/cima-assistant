...
"apixaban", "dabigatran", "edoxaban", "enoxaparina", "bemiparina",
"formoterol", "budesonida", "beclometasona", "montelukast", "tiotropio",
"ipratropio", "carbocisteina", "acetilcisteina", "fexofenadina", "terbutalina",
"aciclovir", "valaciclovir", "finasteride", "dutasterida", "cefuroxima",
"cefixima", "claritromicina", "moxifloxacino", "clindamicina", "doxiciclina",
"nitrofurantoina", "ketoconazol", "fluconazol", "itraconazol", "terbinafina",
"ciclosporina", "metilprednisolona", "piroxicam", "meloxicam", "etoricoxib",
"celecoxib", "sumatriptan", "zolmitriptan", "lamotrigina", "carbamazepina",
"valproato", "topiramato", "fenitoina", "oxcarbazepina", "litio", "aripiprazol",
"paliperidona", "haloperidol", "clozapina", "bupropion", "agomelatina",
"metilfenidato", "atomoxetina", "vortioxetina", "digoxina", "amiodarona",
"flecainida", "espironolactona", "hidroclorotiazida", "indapamida", "doxazosina",
"ivabradina", "ranolazina", "nitroglicerina", "isosorbida", "aliskiren",
"roflumilast", "mesalazina", "sulfasalazina", "acarbosa", "repaglinida",
"sitagliptina", "linagliptina", "dapagliflozina", "gliclazida", "liraglutida",
"calcitonina", "raloxifeno", "denosumab", "teriparatida", "colecalciferol",
"interferon", "adalimumab", "infliximab", "etanercept", "ustekinumab",
"secukinumab", "certolizumab", "golimumab", "abatacept", "tocilizumab",
"belimumab", "rituximab", "enzalutamida", "abiraterona", "letrozol",
"anastrozol", "tamoxifeno", "bicalutamida", "nilutamida", "ciproterona",
"estradiol", "estriol", "estrogenos conjugados", "medroxiprogesterona",
"drospirenona", "desogestrel", "gestodeno", "dienogest", "basiliximab",
"everolimus", "sirolimus", "azatioprina", "metotrexato", "mercaptopurina",
"hidroxicloroquina", "sulfasalazina", "leflunomida", "penicilamina",
"orlistat", "naltrexona", "acamprosato", "disulfiram", "metadona",
"buprenorfina", "vareniclina", "nicotina", "toxina botulinica",
"tetraciclina", "bacitracina", "gentamicina", "ciclopirox", "imiquimod",
"isotretinoina", "betahistina", "sulpirida", "mebeverina", "sucralfato",
"domperidona", "loperamida", "lactulosa", "mesalazina", "simeticona",
"almagato", "plantago ovata", "bisacodilo", "senna", "picosulfato"
